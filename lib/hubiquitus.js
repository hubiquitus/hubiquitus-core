...
/**
 * @type {number}
 * Default timeout (in ms) used when an answer is expected.
 */
var defaultSendTimeout = 30000;

/**
 * @type {number}
 * Max time window to send a message if no timeout and no callback is provided.
 */
 ...
 * @param type {function} reply function
 * @param cb {function} callback
 */
